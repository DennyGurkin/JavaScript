/*
Реализовать модуль корзины на странице. 
У каждого товара есть кнопка «Купить», при нажатии на которую происходит добавление id, 
имени и цены товара в блок корзины. Корзина должна уметь считать общую сумму заказа. 
Один товар можно добавить несколько раз. 
Товары на страницу можно добавить без применения js, 
т.е. просто сверстайте блоки на html/css
*/
"use strict";
