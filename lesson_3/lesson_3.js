/* Задание 2. С помощью цикла for написать алгоритм для вывода чисел от 0 до 10 включительно, 
...
function GetNumbersCount() {
    ...
    for (let i = 0; i <= count; i++){
        ...
        else alert (`${i} - нечетное число`)
    }
}

alert (GetNumbersCount())
...
/* Задание 4.Перед вами находится массив с продуктами, 
...
products.forEach(products => {products.price = products.price* (1-discount);})
console.log(products)


/* Задание 5. Перед вами находится массив с продуктами в интернет-магазине. Вам нужно:*/
...
let ProdPhotos = products.filter(ProdImage => "photos" in ProdImage && ProdImage.photos.length > 0);
...
let SortedByPrice = products.sort(function(product1, product2){
...
ли увеличивать счетчик например на 1, допустимы любые выражения, например вызовы функций. */
